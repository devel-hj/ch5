...
# 딕셔너리 생성
# key - value 쌍
dic = {'apple': 12000, 'banana': 800, 'orange': 1500}
...
# iterable(이터러블) : 수노히가 가능한 객체
for v in dic.values():
    print(v)

# dic.item : 키, 값 모두 가지고 있는 객체
...
# 다음과 같이 학생 점수 디셔너리를 만들어주세요
scores = {'철수': 80, '영희': 95, '민수': 70, '지연': 100}

# for문을 사용해 전체 편균 점수를 구하세요
sum = 0
for value in scores.values():
    sum = sum + value
print(sum / len(scores))

# for문을 사용해 90점 이상 학생의 수를 구하세요
